...
raw_data <- read.csv("D:\\My Drive\\BAP R\\22.10.16_recommender system\\product_ratings_data.csv")
...
image(ratings_matrix[10:30,1:10])
...
recommendations <- recommenderlab::predict(ubcf_recommender, ratings_matrix[1000:1011], n=5)
